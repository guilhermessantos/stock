...
})(["color:#666;border-collapse:collapse;text-align:left;width:100%;thead tr{color:#00214d;border-top:2px solid #DDD;border-bottom:2px solid #DDD;height:60px;}tbody tr{height:50px;&:nth-child(odd){background:#fdfdfd;}}tbody td:first-child{font-weight:bold;text-transform:uppercase;}tbody td:last-child{text-align:right;}"]);
...
//# sourceMappingURL=index.js.ca2e455dbb057ebfe6bb.hot-update.js.map