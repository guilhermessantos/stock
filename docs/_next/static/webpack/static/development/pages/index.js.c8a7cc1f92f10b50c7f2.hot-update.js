...
/***/ "./src/components/table-participation/styles.js":
/*!******************************************************!*\
  !*** ./src/components/table-participation/styles.js ***!
  \******************************************************/
/*! exports provided: Table, Participation, ButtonAction, Message */
...
})(["color:#666;border-collapse:collapse;margin-bottom:15px;text-align:left;width:100%;thead tr{color:#00214d;border-top:2px solid #DDD;border-bottom:2px solid #DDD;height:60px;}tbody tr:nth-child(odd){background:#fdfdfd;}tbody td{height:50px;}tbody td:first-child{font-weight:bold;text-transform:uppercase;}tbody td:last-child{text-align:right;}@media (max-width:479px){table,thead,tbody,th,td,tr{display:block;}thead tr{position:absolute;top:-9999px;left:-9999px;}tbody tr{border-top:2px solid #DDD;padding:10px 0;}tbody td{height:30px;line-height:30px;padding-left:50%;margin:5px 0;position:relative;&:last-child{text-align:left;}}tbody td::before{position:absolute;top:0;left:0;width:50%;white-space:nowrap;}td:nth-child(1)::before{content:'A\xE7\xE3o';}td:nth-child(2)::before{content:'Pre\xE7o atual';}td:nth-child(3)::before{content:'Participa\xE7\xE3o';}td:nth-child(4)::before{content:'Aporte';}td:nth-child(5)::before{content:'Quant.';}.button__remove{border:0;border-radius:5px;height:30px;width:30px;background:red;position:absolute;right:0;}}"]);
...
})(["span{display:inline-block;width:45px;&:first-child{border-right:2px solid #DDD;}}span + span{text-align:right;}"]);
...
})(["align-items:center;color:#00214d;display:flex;font-size:18px;font-weight:bold;justify-content:center;svg{margin:0 5px;}"]);

/***/ })

})
//# sourceMappingURL=index.js.c8a7cc1f92f10b50c7f2.hot-update.js.map